    ...
    <div id="app" class="app app-header-fixed app-sidebar-fixed <?php echo app_sidebar_minified()?>">
        ...
        <div id="content" class="app-content px-3">
            <ol class="breadcrumb float-xl-end">
                ...
                <li class="breadcrumb-item active">ລາຍການຫົວໜ່ວຍ</li>
            </ol>

            <h4 class="page-header" style="font-size:22px !important;font-weight:bold">
                <i class="fas fa-list"></i> ລາຍການຫົວໜ່ວຍ
            </h4>
            <div class="row mb-2">
                <div class="col-md-2 mb-2">
                    <button type="button" class="btn btn-outline-orange" onclick="modal_open('modal_unite','ເພີ່ມຫົວໜ່ວຍສິນຄ້າ','frm_unite','btn_save','unite_name','','','','')">
        ...
        <script>
            load_data_setting($("#search_page").val(),$("#limit_page").val(),$("#order_page").val(),pagin="1","service-unite.php?fetch_data","display");
            service_insert("frm_unite", "service-unite.php?insert_data", "modal_unite",$("#search_page").val(),$("#limit_page").val(),$("#order_page").val(),pagin="1","service-unite.php?fetch_data","display");
            $(document).on('click', '.page-link', function() {
                var page = $(this).data('page_number');
                if (page != undefined) {
                    load_data_setting($("#search_page").val(),$("#limit_page").val(),$("#order_page").val(),page,"service-unite.php?fetch_data","display");
                }
            });
