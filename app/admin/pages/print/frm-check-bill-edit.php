...
$sqlBill=$db->fn_fetch_single_all("view_daily_report_group WHERE list_bill_no='".($_GET["bill_no"])."' ");
?>
...
<body>
    <div class="ticket">
        ...
        <p class="text_light">ເລກບິນ : <?php echo ($_GET["bill_no"]);?></p>
        ...
        <table class="tbname">
            ...
            <tbody>
                ...
                <?php 
                    $sqlPreview=$db->fn_read_all("view_daily_report_list WHERE check_bill_list_bill_fk='".$_GET["bill_no"]."'");
    ...
    <?php 
    $deleteOrder=$db->fn_delete("res_orders_list_edit WHERE order_list_bill_fk='".base64_decode($_GET["bill_no"])."' ");
