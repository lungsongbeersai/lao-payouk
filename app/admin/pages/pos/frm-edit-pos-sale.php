...
$billName = $db->fn_fetch_single_all("res_bill WHERE bill_code='" . $bill_no . "' AND bill_status='2' ");

$sqlpos1=$db->fn_fetch_rowcount("res_check_bill_list WHERE check_bill_list_bill_fk='".$bill_no."' ");
$sqlpos=$db->fn_fetch_rowcount("res_orders_list_edit WHERE order_list_bill_fk='".$bill_no."' ");

if($sqlpos1==$sqlpos){
    if($sqlpos==0){
        $sqlBill=$db->fn_read_all("res_check_bill_list WHERE check_bill_list_bill_fk='".$bill_no."' ");
        foreach($sqlBill as $rowBill){
            // $auto_number = $db->fnBillNumber("order_list_code", "res_orders_list_edit");
            $insert="'".$rowBill["check_bill_list_code"]."',
            '".$rowBill["check_bill_list_date"]."',
            '".$rowBill["check_bill_list_branch_fk"]."',
            '".$rowBill["check_bill_list_bill_fk"]."',
            '".$rowBill["check_bill_list_table_fk"]."',
            '".$rowBill["check_bill_list_table_fk"]."',
            '".$rowBill["check_bill_list_pro_code_fk"]."',
            '".$rowBill["check_bill_list_pro_price"]."',
            '".$rowBill["check_bill_list_order_qty"]."',
            '".$rowBill["check_bill_list_order_total"]."',
            '".$rowBill["check_bill_list_status_promotion"]."',
            '".$rowBill["check_bill_list_qty_promotion_all"]."',
            '".$rowBill["check_bill_list_qty_promotion_gif"]."',
            '".$rowBill["check_bill_list_qty_promotion_total"]."',
            '".$rowBill["check_bill_list_discount_status"]."',
            '".$rowBill["check_bill_list_discount_percented"]."',
            '".$rowBill["check_bill_list_discount_percented_name"]."',
            '".$rowBill["check_bill_list_discount_price"]."',
            '".$rowBill["check_bill_list_discount_total"]."',
            '".$rowBill["check_bill_list_status"]."',
            '".$rowBill["check_bill_list_status_order"]."',
            '".$rowBill["check_bill_list_note_remark"]."',
            '1',
            '1'";

            $sqlInsert=$db->fn_insert("res_orders_list_edit",$insert);

        }
    }
}else{
    $delete=$db->fn_delete("res_orders_list_edit WHERE order_list_bill_fk='".$bill_no."'");
    $sqlBill=$db->fn_read_all("res_check_bill_list WHERE check_bill_list_bill_fk='".$bill_no."' ");
        foreach($sqlBill as $rowBill){
            $insert="'".$rowBill["check_bill_list_code"]."',
            '".$rowBill["check_bill_list_date"]."',
...
<body class='pace-top'>
        ...
        <div id="content" class="app-content p-0">
            <div class="pos pos-customer" id="pos-customer" style="background-color:#f4f1ef !important;">
                <div class="pos-menu" style="overflow-y:hidden !important;background:#DB4900 !important;">
                    ...
                    <?php
                    $sqlPromotion = $db->fn_fetch_rowcount("view_promotion WHERE DATE(promo_end_date)>=DATE(NOW())");
                    if ($sqlPromotion > 0) {
                ...
                <div class="pos-content" style="overflow:hidden">
                    <div class="pos-content-container" data-scrollbar="true" data-height="100%" data-skip-mobile="true">
                        <div class="row mb-3">
                            <div class="col-md-9">
                                <a href="?cancel" type="button" class="btn btn-danger text-light"> <i class="fas fa-arrow-circle-left"></i> ກັບຄືນ</a>
                            </div>
                            <div class="col-md-3">
                    ...
                    <form id="frmBill">
                        <div class="modal-body">
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group mb-1">
                                        <label for="" class="mb-2">ວັນທີ່ແກ້ໄຂ </label>
                                        <?php 
                                            $sqlCheckbill=$db->fn_fetch_single_all("res_check_bill WHERE list_bill_no='".$bill_no."' ");
                                        ?>
                                        <input type="date" class="form-control input_color" name="list_bill_date" id="list_bill_date" value="<?php echo date("Y-m-d",strtotime($sqlCheckbill["list_bill_date"]))?>">
                                    </div>
                                </div>
                        ...
                        <div class="modal-footer justify-content-between">
                            <button type="submit" class="btn btn-primary btn-lg" id="btn_payment" disabled><i class="fas fa-save"></i> ແກ້ໄຂບິນ</button>
                        </div>
                    </form>
                </div>
            </div>
    ...
    <script>
        ...
        $("#frmCutlist").on("submit",function(event){
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    $.ajax({
                        url: "services/sql/service-pos-edit.php?cutlist_url",
                        method: "POST",
        ...
        function fnCut_list(billNo,tableID,tableName){
            $.ajax({
                url: "services/sql/service-pos-edit.php?cutList",
                method:"POST",
        ...
        $(document).on("click","#bokenTb",function(){
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    $.ajax({
                        url: "services/sql/service-pos-edit.php?editBoken",
                        method: "POST",
        ...
        $("#confirmSumTable").on("submit", function(event) {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        url: "services/sql/service-pos-edit.php?editStatusTb",
                        method: "POST",
                        data: new FormData(this),
                        contentType: false,
                        processData: false,
        ...
        //     $.ajax({
        //         url: "services/sql/service-pos-edit.php?deleteMoveAll",
        //         method: "POST",
        //         data: {
        //             confirmExite
        //         },
        ...
        function loadSumTable(){
            ...
            var table_no=$("#table_no").val();
            $.ajax({
                url: "services/sql/service-pos-edit.php?sumTable",
                method: "POST",
                data:{bill_no,table_no},
                success:function(data){
                    $("#loadTable").html(data);
        ...
        function ChangeZoneMove() {
            ...
            var table_no=$("#table_no").val();
            $.ajax({
                url: "services/sql/service-pos-edit.php?fetchZoneMoves",
                method: "POST",
                data: {
        ...
        function ChangeZone() {
            ...
            var table_no=$("#table_no").val();
            $.ajax({
                url: "services/sql/service-pos-edit.php?fetchTable",
                method: "POST",
                data: {
                    table_zone_fk,table_no
                },
        ...
        function fnMoveTb(urlData, modalID, showID) {
            ...
            $.ajax({
                url: "services/sql/service-pos-edit.php?" + urlData,
                method: "POST",
                data: {
                    tableCode,
                    tableName,
        ...
        function loadMoveTb() {
            ...
            $.ajax({
                url: "services/sql/service-pos-edit.php?loadMoveTb",
                method: "POST",
                data: {
                    table_no,
                    table_name,
        ...
        function addMove() {
            ...
            if (tbList != "") {
                $.ajax({
                    url: "services/sql/service-pos-edit.php?insertMove",
                    method: "POST",
                    data: {
                        tbList,
                        table_no,
        ...
        function fnDelete(dataID,oldTable,Newtable) {
            $.ajax({
                url: "services/sql/service-pos-edit.php?deleteData",
                method: "POST",
                data: {
        ...
        $("#frmRemoveTb").on("submit", function(event) {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    var bill_no = $("#bill_no").val();
                    $.ajax({
                        url: "services/sql/service-pos-edit.php?urlRemoveTb",
                        method: "POST",
                        data: new FormData(this),
                        contentType: false,
                        processData: false,
    ...
    <script>
            ...
            if ($("#list_bill_type_pay_fk").val() === "3") {
                ...
                if (countCash === 0 && counttransfer === 0) {
                    ...
                    if (list_bill_return >= "0") {
                        $.ajax({
                            url: "services/sql/service-pos-edit.php?insertAll",
                            method: "POST",
                            data: new FormData(this),
                            contentType: false,
                            processData: false,
        ...
        $("#insertCustommer").on("submit", function(e) {
            e.preventDefault();
            $.ajax({
                url: "services/sql/service-pos-edit.php?insertCustommer",
                method: "POST",
                data: new FormData(this),
                contentType: false,
                processData: false,
        ...
        function load_category(cate_item) {
            ...
            $.ajax({
                url: "services/sql/service-pos-edit.php?product_list",
                method: "POST",
                data: {
                    cate_item
                },
        ...
        function load_orders() {
            ...
            $.ajax({
                url: "services/sql/service-pos-edit.php?order_list",
                method: "POST",
                data: {
                    table_no,
                    table_name_list,
        ...
        $(document).on("click", ".modal_products", function() {
            ...
            $.ajax({
                url: "services/sql/service-pos-edit.php?product_modal",
                method: "POST",
                data: {
        ...
        function fnChangePrice(pro_detail_code, product_cut_stock,txtStatusPro,txtgif,stockQty) {
            ...
            $.ajax({
                url: "services/sql/service-pos-edit.php?changePrice",
                method: "POST",
                data: {
                    pro_detail_code
                },
        ...
        function Plus_fn(dataInput) {
            ...
            if (txtCutStock === "2") {
                $.ajax({
                    url: "services/sql/service-pos-edit.php?changeQty",
                    method: "POST",
                    data: {
                        txtDetailCode,
                        order_list_pro_qty,
        ...
        $("#addOrder").on("submit", function(event) {
            event.preventDefault();
            $.ajax({
                url: "services/sql/service-pos-edit.php?addProduct",
                method: "POST",
                data: new FormData(this),
                contentType: false,
                processData: false,
        ...
        function fnDeleteOrder(idTb,idBill,idOrder, idProduct, idQty, idStock, idCate,gifAmount) {
            ...
            $.ajax({
                url: "services/sql/service-pos-edit.php?deleteOrder",
                method: "POST",
                data: {
                    idTb,
                    idBill,
        ...
        function fnPlusQty(idOrder, cutStock, price, plus, proCode, perPrice,gifQty,gifAmount) {
            ...
            $.ajax({
                url: "services/sql/service-pos-edit.php?changPlusQty",
                method: "POST",
                data: {
                    idOrder,
                    cutStock,
        ...
        $("#addPercented").on("submit", function(event) {
            ...
            if ($("#percented").val() == "") {
                ...
                $.ajax({
                    url: "services/sql/service-pos-edit.php?editPercented",
                    method: "POST",
                    data: new FormData(this),
                    contentType: false,
                    processData: false,
        ...
        $(document).on("click", "#confirm_orders", function() {
            ...
            $.ajax({
                url: "services/sql/service-pos-edit.php?editStatusTable",
                method: "POST",
                data: {
                    table_no,
                    bill_no
