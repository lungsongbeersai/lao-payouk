...
?>
    <thead style="border: 1px solid white !important;vertical-align:middle !important;">
        <tr>
            <th rowspan="2" widtd="5%" style="text-align:center !important;">ລໍາດັບ</th>
            <th rowspan="2" align="center" class="th_center">ເລກບິນ</th>
            <th rowspan="2" style="text-align: center;">ວັນທີ່ຂາຍ</th>
            <th rowspan="2" align="center">ເບີໂຕະ</th>
            <th colspan="2" align="center" class="th_center">ອັດຕາແລກປ່ຽນ</th>
            <th rowspan="2">ປະເພດຊໍາລະ</th>
            <th rowspan="2">ຈໍານວນ</th>
            <th rowspan="2">ລາຄາລວມ</th>
            <th rowspan="2">ລູກຄ້າຕິດໜີ້</th>
            <th colspan="2" align="center" class="th_center">ສ່ວນຫຼຸດ</th>
            <th rowspan="2">ຍອດຂາຍລວມ</th>
            <th colspan="3" align="center" class="bg-primary th_center">ຈ່າຍເງິນສົດ</th>
            <th colspan="3" align="center" class="bg-orange th_center">ຈ່າຍເງິນໂອນ</th>
            <th rowspan="2" align="center" class="th_center">ເງິນທອນ</th>
            <th rowspan="2" align="center" class="th_center">ຍອດຂາຍຕົວຈິງ</th>
        </tr>
        <tr>
            <th align="center">ບາດ-ກີບ</th>
            <th align="center">ໂດຣາ-ກີບ</th>
            <th align="center">ເງິນ</th>
            <th align="center">ເປີເຊັນ</th>
            <th align="center" class="bg-primary">ກີບ</th>
            <th align="center" class="bg-primary">ບາດ</th>
            <th align="center" class="bg-primary">ໂດຣາ</th>
            <th align="center" class="bg-orange">ກີບ</th>
            <th align="center" class="bg-orange">ບາດ</th>
            <th align="center" class="bg-orange">ໂດຣາ</th>
        </tr>
    </thead>
    <tbody class="table-bordered-y table-sm display">
        <?php
            ...
            foreach($fetch_sql as $row_sql){
                ...
                @$sumTotal1+=$row_sql["list_bill_amount_kip"];
...
?>
            <tr class="table_hover <?php echo $color;?>">
                ...
                <td align="center">
                    <a href="?print_Preview&&list_bill_no=<?php echo base64_encode($row_sql['list_bill_no'])?>&&tableName=<?php echo base64_encode($row_sql['table_name'])?>&&branch_code=<?php echo base64_encode($row_sql['list_bill_branch_fk'])?>" target="_bank" style="text-decoration:none;color:#DB4900 !important"><?php echo $row_sql["list_bill_no"]?></a>
                </td>
                ...
                <td align="right"><?php echo @number_format($row_sql["list_bill_amount"]);?></td>
                ...
                <td align="right"><?php echo @number_format($row_sql["list_bill_amount_kip"]);?></td>
        ...
        <tr style="border-top:1px solid #DEE2E6;background:#0F253B;color:#eaeaea;font-size:16px !important;">
            ...
            <td align="right"><?php echo @number_format($sumTotal1)?></td>
        ...
        <?php }else{?>
            <tr>
                <td colspan="21" align="center" style="height:380px;padding:150px;color:red">
        ...
        <?php 
            ...
            foreach($sqlreport as $rowreport){
                ...
                if($rowreport["list_bill_type_pay_fk"]!="4"){
                    @$totalAmount+=$rowreport["list_bill_amount"];
                }else{
                    @$totalAmount+=0;
                }
