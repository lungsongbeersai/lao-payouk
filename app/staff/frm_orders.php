...
$sqlCount = $db->fn_fetch_rowcount("res_bill WHERE bill_branch='" . $_SESSION["user_branch"] . "' AND bill_table='" . $table_code . "' AND bill_status='1'");
if ($sqlCount == 0) {
    $auto_number = $db->fn_autonumber("bill_code", "res_bill");
    $auto_q = $db->fnNumber("bill_q", "res_bill");
    $sqlAuto = "'" . $auto_number . "','" . $table_code . "','" . $_SESSION["user_branch"] . "','1','".date("Y-m-d")."','".$auto_q."'";
    $insertBill = $db->fn_insert("res_bill", $sqlAuto);
}

$billName = $db->fn_fetch_single_all("res_bill WHERE bill_table='" . $table_code . "' AND bill_status='1' AND bill_branch='" . $_SESSION["user_branch"] . "' ");
...
<body>
    ...
    <input type="text" hidden id="user_branch" name="user_branch" value="<?php echo $_SESSION["user_branch"]; ?>">
    <input type="text" hidden id="users_id" name="users_id" value="<?php echo $_SESSION["users_id"]; ?>">
    ...
    <div class="appHeader bg-primary text-light">
        <div class="left">
            <a href="?main" class="headerButton">
                <ion-icon src="api/images/svg/chevron-back-outline.svg"></ion-icon>
            </a>
        </div>
        <div class="pageTitle">ເບີໂຕະ <?php echo $table_name ?> </div>
        <div class="right">
    ...
    <div id="appCapsule" class="extra1-header-active" style="margin-top:85px;">
        ...
        <div id="draggable" draggable="true" class="draggable" onClick="shoppingDetail()">
            <!-- <img src="assets/img/shopping20.png" alt="Shopping Cart"> -->
            ...
            <form id="confirm_orders">
                <div class="modal-content">
                    ...
                    <div class="modal-body px-1">
                        <div class="section mb-5 px-1" id="cart_detail" style="margin-bottom: 2rem !important;">
                        ...
                        <div class="section bg-primary">
                            <button type="submit" class="btn btn-primary btn-lg btn-block fixed-bottom square emit_submit_ordersPY">
                                </ion-icon><ion-icon src="api/images/svg/print-outline.svg"></ion-icon> ຢືນຢັນການສັ່ງ
                            </button>
                        </div>
                    </div>
                </div>
    ...
    <div class="modal fade dialogbox" id="QR_Code" data-bs-backdrop="static" tabindex="-1" role="dialog">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <input type="text" hidden name="urlCode" id="urlCode" value="<?php include("assets/js/ip.php");?>?bill_code=<?php echo base64_encode($billName["bill_code"]);?>&table_code=<?php echo @$_GET["table_code"] ; ?>&table_name=<?php echo @($_GET["table_name"]); ?>&users_id=<?php echo base64_encode(@$_SESSION["users_id"]); ?>&user_branch=<?php echo base64_encode(@$_SESSION["user_branch"]); ?>" style="width:80%">
                <center>
                    <br>
                    <h2>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="cart-item-footer">
                                            ...
                                            <button type="button" class="btn btn-danger btn-sm" onClick="fnDeleteOrder('${rowData.order_list_table_fk}','${rowData.order_list_bill_fk}','${rowData.order_list_code}','${rowData.order_list_pro_code_fk}','${rowData.order_list_order_qty}','${rowData.product_cut_stock}','${rowData.cateDelete}','${rowData.order_list_qty_promotion_gif_total}')">
                                                <ion-icon src="api/images/svg/trash-outline.svg"></ion-icon> ລິບ
                                            </button>
                                        </div>
                                    </div>
                                </div>
                        ...
                        for (var count = 0; count < data.length; count++) {
                            ...
                            for (var count1 = 0; count1 < data1.length; count1++) {
                                ...
                                if (rowData1.product_cate_fk === rowData.cate_code) {
                                    ...
                                    html += `
                                        <div class="session_grid_item1 px-0 ${cardAvilable}" ${checkAvilable}>
                                            <div class="img-hover1">
                                                ...
                                                <div class="session_grid_img1 img-hover1">
                                                    <img src="${product_images}" alt="image" class="imaged w-100 img" style="height:140px;">
                                                </div>
