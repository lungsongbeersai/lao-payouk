...
<body>
    ...
    <div class="appHeader bg-primary text-light">
        ...
        <div class="pageTitle">ຫ້ອງຄົວ</div>
    </div>
    ...
    <nav class="nav-horizontal-scroll fixed-top" style="z-index:800 !important;">
        <ul style="margin-top:-53px !important;background:#ffffff">
            ...
            <li data-page="two" class="nav_font" id="actives3" onClick="load_orders(3)">
                ກໍາລັງຄົວ <span class="badge3_" style="font-size:18px;">0</span>
            </li>
            <li data-page="three" class="nav_font" id="actives4" onClick="load_orders(4)">
                ຄົວສໍາເລັດ <span class="badge4_" style="font-size:18px;">0</span>
            </li>
    ...
    <script>
        ...
        function load_orders(idStatus) {
            ...
            $.ajax({
                url: urlApi + "api-cooks.php?loadOrders",
                method: "POST",
                data: {
                    idStatus
                },
                    ...
                    if (response == "201") {
                        ...
                        for (var count = 0; count < data.length; count++) {
                            ...
                            if (rowData.order_list_status_order == "2") {
                                ...
                                status_cm = "3";
                                button_name = "<i class='fa fa-check fa-fw fa-shake'></i> ຢືນຢັນຄົວສໍາເລັດ";
                                disabled_bt = "";
                            } else if (rowData.order_list_status_order == "4") {
                                status_cm = "4";
                                button_name = "<i class='fas fa-spinner fa-spin fa-fw'></i> ລໍຖ້າເສີບອາຫານ";
                            ...
                            html += `
                                <div class="session_grid_item1 px-0">
                                    <div class="img-hover1">
                                        ...
                                        <div class="session_gird_footer1 px-2" style="margin-top:-15px;font-size:12px;">
                                        ...
                                        <div class="session_gird_footer1" style="margin-top:-15px;">
                                            <button type="button" class="btn btn-primary btn-block" ${disabled_bt} ${disabled_limit} onclick="fnConfirm('${rowData.order_list_code}','${status_cm}')">
                                                ${button_name}
                                            </button>
                                        </div>
        ...
        function countData() {
            $.ajax({
                url: urlApi + "api-cooks.php?countLabel",
                method: "POST",
                dataType: "json",
        ...
        function fnConfirm(cookID, cookStatus) {
            ...
            $.ajax({
                url: urlApi + "api-cooks.php?editStatus",
                method: "POST",
                data: {
                    cookID,
                    cookStatus
